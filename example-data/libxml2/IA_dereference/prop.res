xmlAutomataGetInitState_APIName returns the initial xmlAutomataGetInitState_APIParam_0 of the xmlAutomataGetInitState_APIParam_1
xmlAutomataNewCountTrans_APIParam_3 is the target point of the xmlAutomataNewCountTrans_APIParam_3 or NULL
xmlAutomataNewCountTrans2_APIParam_3 is the target point of the xmlAutomataNewCountTrans2_APIParam_3 or NULL
xmlAutomataNewAllTrans_APIParam_3 is the target point of the xmlAutomataNewAllTrans_APIParam_3 or NULL
xmlAutomataNewCountedTrans_APIParam_3 is the target point of the xmlAutomataNewCountedTrans_APIParam_3 or NULL
xmlAutomataNewCounterTrans_APIParam_3 is the target point of the xmlAutomataNewCounterTrans_APIParam_3 or NULL
xmlAutomataNewEpsilon_APIParam_3 is the target point of the xmlAutomataNewEpsilon_APIParam_3 or NULL
xmlAutomataNewOnceTrans_APIParam_3 is the target point of the xmlAutomataNewOnceTrans_APIParam_3 or NULL
xmlAutomataNewNegTrans_APIParam_3 is the target point of the xmlAutomataNewNegTrans_APIParam_3 or NULL
xmlAutomataNewOnceTrans2_APIParam_3 is the target point of the xmlAutomataNewOnceTrans2_APIParam_3 or NULL
xmlAutomataNewTransition_APIParam_3 is the target point of the xmlAutomataNewTransition_APIParam_3 or NULL
xmlAutomataNewTransition2_APIParam_3 is the target point of the xmlAutomataNewTransition2_APIParam_3 or NULL
The xmlAutomataCompile_APIParam_1 should be free after this point
xmlAutomataNewAllTrans_APIName returns the xmlAutomataNewAllTrans_APIParam_3 or NULL in case of error
xmlAutomataNewCountTrans2_APIName returns the xmlAutomataNewCountTrans2_APIParam_3 or NULL in case of error
xmlAutomataNewCountTrans_APIName returns the xmlAutomataNewCountTrans_APIParam_3 or NULL in case of error
xmlAutomataNewCountedTrans_APIName returns the xmlAutomataNewCountedTrans_APIParam_3 or NULL in case of error
xmlAutomataNewCounterTrans_APIName returns the xmlAutomataNewCounterTrans_APIParam_3 or NULL in case of error
xmlAutomataNewNegTrans_APIName returns the xmlAutomataNewNegTrans_APIParam_3 or NULL in case of error
xmlAutomataNewOnceTrans_APIName returns the xmlAutomataNewOnceTrans_APIParam_3 or NULL in case of error
xmlAutomataNewEpsilon_APIName returns the xmlAutomataNewEpsilon_APIParam_3 or NULL in case of error
xmlAutomataNewOnceTrans2_APIName returns the xmlAutomataNewOnceTrans2_APIParam_3 or NULL in case of error
xmlAutomataNewTransition_APIName returns the xmlAutomataNewTransition_APIParam_3 or NULL in case of error
xmlAutomataNewTransition2_APIName returns the xmlAutomataNewTransition2_APIParam_3 or NULL in case of error
...
xmlRegexpCompile_APIName returns the compiled xmlRegexpCompile_APIParam_1 or NULL in case of error
...
xmlValidatePopElement_APIName returns 1 if no xmlValidatePopElement_APIParam_1 was found or 0 otherwise
xmlValidatePushCData_APIName returns 1 if no xmlValidatePushCData_APIParam_2 was found or 0 otherwise
xmlValidatePushElement_APIName returns 1 if no xmlValidatePushElement_APIParam_1 was found or 0 otherwise
...
xmlXPathCompiledEvalToBoolean_APIName returns 1 if the xmlXPathCompiledEvalToBoolean_APIParam_1 evaluated to true, 0 if to false and -1 in API and internal errors
...
xmlSchemaValidateStream_APIName returns 0 if the document is xmlSchemaValidateStream_APIParam_1 valid, a positive xmlSchemaValidateStream_APIParam_3 otherwise and -1 in case of internal or API error
...
xmlRelaxNGValidateFullElement_APIName returns 1 if no xmlRelaxNGValidateFullElement_APIParam_1 was found or -1 in case of error
xmlRelaxNGValidatePopElement_APIName returns 1 if no xmlRelaxNGValidatePopElement_APIParam_1 was found or 0 otherwise
xmlRelaxNGValidatePushCData_APIName returns 1 if no xmlRelaxNGValidatePushCData_APIParam_2 was found or -1 otherwise
...
xmlParseChunk_APIName returns zero if no error, the xmlParseChunk_APIParam_1 otherwise
xmlParseCtxtExternalEntity_APIName returns 0 if the entity is well formed, -1 in case of args problem and the xmlParseCtxtExternalEntity_APIParam_1 otherwise
...
xmlNodeGetSpacePreserve_APIName returns -1 if xmlNodeGetSpacePreserve_APIParam_1 is not inherited, 0 if "default", 1 if "preserve
...
UTF8ToHtml_APIName returns 0 if success, -2 if the transcoding fails, or -1 otherwise The value of UTF8ToHtml_APIParam_4 after return is the number of octets consumed as the return value is positive, else unpredictable
htmlElementAllowedHere_APIName returns 1 if allowed
htmlEncodeEntities_APIName returns 0 if success, -2 if the transcoding fails, or -1 otherwise The value of htmlEncodeEntities_APIParam_4 after return is the number of octets consumed as the return value is positive, else unpredictable
htmlParseChunk_APIName returns zero if no error, the htmlParseChunk_APIParam_1 otherwise
...
xmlCatalogIsEmpty_APIName returns 1 if the xmlCatalogIsEmpty_APIParam_1 is empty, 0 if not, amd -1 in case of error
...
xmlSchemaValidateFacet_APIName returns 0 if the element is xmlSchemaValidateFacet_APIParam_4 valid, a positive error code number otherwise and -1 in case of internal or API error
xmlSchemaValidateFacetWhtsp_APIName returns 0 if the element is xmlSchemaValidateFacetWhtsp_APIParam_6 valid, a positive error code number otherwise and -1 in case of internal or API error
...
This is not reentrant
This is not reentrant
htmlCreateFileParserCtxt_APIName returns the new htmlCreateFileParserCtxt_APIParam_2 or NULL
xmlCreateFileParserCtxt_APIName returns the new xmlCreateFileParserCtxt_APIParam_1 or NULL
xmlCreateMemoryParserCtxt_APIName returns the new xmlCreateMemoryParserCtxt_APIParam_1 or NULL
xmlCreateEntityParserCtxt_APIName returns the new xmlCreateEntityParserCtxt_APIParam_3 or NULL
xmlCreateURLParserCtxt_APIName returns the new xmlCreateURLParserCtxt_APIParam_1 or NULL
xmlCreateDocParserCtxt_APIName returns the new xmlCreateDocParserCtxt_APIParam_1 or NULL
xmlCreateIOParserCtxt_APIName returns the new parser context or NULL
xmlCreatePushParserCtxt_APIName returns the new xmlCreatePushParserCtxt_APIParam_5 or NULL
htmlCreateMemoryParserCtxt_APIName returns the new htmlCreateMemoryParserCtxt_APIParam_1 or NULL
htmlCreatePushParserCtxt_APIName returns the new htmlCreatePushParserCtxt_APIParam_5 or NULL
htmlCreateFileParserCtxt_APIParam_2 is a free htmlCreateFileParserCtxt_APIParam_2 describing the HTML document htmlCreateFileParserCtxt_APIParam_2 , or NULL
htmlParseDoc_APIParam_2 is a free htmlParseDoc_APIParam_1 describing the HTML document htmlParseDoc_APIParam_2 , or NULL
htmlParseFile_APIParam_2 is a free htmlParseFile_APIParam_2 describing the HTML document htmlParseFile_APIParam_2 , or NULL
htmlSAXParseDoc_APIParam_2 is a free htmlSAXParseDoc_APIParam_1 describing the HTML document htmlSAXParseDoc_APIParam_2 , or NULL
htmlSAXParseFile_APIParam_2 is a free htmlSAXParseFile_APIParam_2 describing the HTML document htmlSAXParseFile_APIParam_2 , or NULL
...
xmlDecodeEntities_APIName is deprecated , we now always process entities content through xmlDecodeEntities_APIParam_6
...
xmlStringDecodeEntities_APIName returns A newly allocated xmlStringDecodeEntities_APIParam_2 with the substitution done
xmlStringLenDecodeEntities_APIName returns A newly allocated xmlStringLenDecodeEntities_APIParam_2 with the substitution done
...
xmlParsePubidLiteral_APIName returns the xmlParsePubidLiteral_APIParam_1 parsed or NULL
xmlParseSystemLiteral_APIName returns the SystemLiteral xmlParseSystemLiteral_APIParam_1 or NULL
...
2.11 xmlCurrentChar_APIParam_2 an external parsed entity or the literal entity value of an internal parsed entity contains either the literal two-character sequence  #xD #xA  or a standalone literal #xD , an xmlCurrentChar_APIParam_1 must pass to the application the single character #xA
A name must not appear more than once in an xmlParseAttributeType_APIParam_2 as a value of this type
...
each IDREF Name must match the value of an ID attribute on some element in the xmlParseAttributeType_APIParam_2
= ` ID ' | ` IDREF ' | ` IDREFS ' | ` ENTITY ' | ` ENTITIES ' | ` NMTOKEN ' | ` NMTOKENS ' xmlValidateAttributeValue_APIParam_2 for attribute values syntax are checked in xmlValidateAttributeValue_APIName Values of xmlValidateAttributeValue_APIParam_1 must match the Name production
Before the value of an attribute is passed to the application or checked for validity , the xmlParseAttValue_APIParam_1 must normalize it as follows
...
Skip an xmlParseComment_APIParam_1 <!-- .... --> The spec says that  For compatibility , the string  --  must not occur within comments
= ' #REQUIRED ' xmlParseDefaultDecl_APIParam_1 ' #IMPLIED
...
The declaration of a xmlParserHandlePEReference_APIParam_1 must precede any reference to it
The declaration of a xmlParserHandlePEReference_APIParam_1 must precede any reference to it
The declaration of a xmlParserHandlePEReference_APIParam_1 must precede any reference to it
The declaration of a xmlParserHandlePEReference_APIParam_1 must precede any reference to it
The declaration of a xmlParserHandlePEReference_APIParam_1 must precede any reference to it
...
' In a document without any DTD , a document with only an internal DTD subset which contains no xmlParseEntityRef_APIParam_1 , or a document with  standalone = ` yes '  , the Name given in the entity reference must match that in an entity declaration , except that well-formed documents need not declare any of the following entities
Values of this type must match one of the Nmtoken tokens in the declaration
In the internal DTD subset , xmlParseMarkupDecl_APIParam_1 can occur only where markup declarations can occur , not within markup declarations
...
The declaration of a xmlParserHandlePEReference_APIParam_1 must precede any reference to it ... xmlParserHandlePEReference_APIParam_1 may only appear in the DTD
The declaration of a xmlParserHandlePEReference_APIParam_1 must precede any reference to it ... xmlParserHandlePEReference_APIParam_1 may only appear in the DTD
The declaration of a xmlParserHandlePEReference_APIParam_1 must precede any reference to it ... xmlParserHandlePEReference_APIParam_1 may only appear in the DTD
The declaration of a xmlParserHandlePEReference_APIParam_1 must precede any reference to it ... xmlParserHandlePEReference_APIParam_1 may only appear in the DTD
xmlParseQuotedString_APIName returns the xmlParseQuotedString_APIParam_1 or NULL
...
xmlParseSDDecl_APIName returns 1 if standalone="yes" 0 if standalone="no" -2 if standalone attribute is missing or invalid (A standalone value of -2 means that the xmlParseSDDecl_APIParam_1 was found, but no value was specified for the standalone attribute
...
In a document without any DTD , a document with only an internal DTD subset which contains no xmlParserHandlePEReference_APIParam_1 , or a document with  standalone = ` yes
In a document without any DTD , a document with only an internal DTD subset which contains no xmlParserHandlePEReference_APIParam_1 , or a document with  standalone = ` yes
In a document without any DTD , a document with only an internal DTD subset which contains no xmlParserHandlePEReference_APIParam_1 , or a document with  standalone = ` yes
In a document without any DTD , a document with only an internal DTD subset which contains no xmlParserHandlePEReference_APIParam_1 , or a document with  standalone = ` yes
+ In practice allow
...
seems deprecated now , only used in the xmlScanName_APIParam_1 of xmlParserHandleReference NameChar
Used only
...
xmlAddElementDecl_APIName returns NULL if not, otherwise the xmlAddElementDecl_APIParam_5
xmlAddID_APIName returns NULL if not, otherwise the new xmlAddID_APIParam_4
...
xmlCopyAttributeTable_APIName returns the new xmlCopyAttributeTable_APIParam_1 or NULL in case of error
xmlCopyDocElementContent_APIName returns the new xmlCopyDocElementContent_APIParam_2 or NULL in case of error
xmlCopyElementContent_APIName returns the new xmlCopyElementContent_APIParam_1 or NULL in case of error
xmlCopyElementTable_APIName returns the new xmlCopyElementTable_APIParam_1 or NULL in case of error
xmlCopyNotationTable_APIName returns the new xmlCopyNotationTable_APIParam_1 or NULL in case of error
xmlExpNewAtom_APIName returns the xmlExpNewAtom_APIParam_0 or NULL in case of error
xmlExpNewOr_APIName returns the xmlExpNewOr_APIParam_3 or NULL in case of error
xmlExpNewRange_APIName returns the xmlExpNewRange_APIParam_2 or NULL in case of error
xmlExpNewSeq_APIName returns the xmlExpNewSeq_APIParam_3 or NULL in case of error
...
xmlCopyEntitiesTable_APIName returns the new xmlCopyEntitiesTable_APIParam_1 or NULL in case of error
...
xmlAddNextSibling_APIName returns the new xmlAddNextSibling_APIParam_2 or NULL in case of error
xmlAddPrevSibling_APIName returns the new xmlAddPrevSibling_APIParam_2 or NULL in case of error
...
xmlCopyEnumeration_APIName returns the xmlCopyEnumeration_APIParam_1 just created or NULL in case of error
...
xmlNewDocElementContent_APIName returns NULL if not, otherwise the new xmlNewDocElementContent_APIParam_3 content structure
xmlNewElementContent_APIName returns NULL if not, otherwise the new xmlNewElementContent_APIParam_2 content structure
Deprecated in favor of xmlNewElementContent_APIParam_2
...
xmlValidCtxtNormalizeAttributeValue_APIParam_1 is the xmlValidCtxtNormalizeAttributeValue_APIParam_1 or NULL
...
xmlValidGetPotentialChildren_APIName returns the number of xmlValidGetPotentialChildren_APIParam_1 in the list, or -1 in case of error
...
xmlValidGetValidElements_APIParam_3 -LRB- NULL , xmlValidGetValidElements_APIParam_2 - > childs , to append a child to ` xmlValidGetValidElements_APIParam_2
xmlValidGetValidElements_APIParam_3 -LRB- xmlValidGetValidElements_APIParam_2 - > last , NULL , ... pointers to the element xmlValidGetValidElements_APIParam_3 are inserted at the beginning of the array and do not need to be freed
the xmlValidNormalizeAttributeValue_APIParam_4 must further process the normalized attribute xmlValidNormalizeAttributeValue_APIParam_4 by discarding any leading and trailing xmlValidNormalizeAttributeValue_APIParam_4 , and by replacing sequences of xmlValidNormalizeAttributeValue_APIParam_4 by single space character
the xmlValidCtxtNormalizeAttributeValue_APIParam_5 must further process the normalized attribute xmlValidCtxtNormalizeAttributeValue_APIParam_5 by discarding any leading and trailing xmlValidCtxtNormalizeAttributeValue_APIParam_5 , and by replacing sequences of xmlValidCtxtNormalizeAttributeValue_APIParam_5 by single space character
...
xmlNanoFTPNewCtxt_APIName returns an xmlNanoFTPNewCtxt_APIParam_1 or NULL in case of error
xmlIOFTPOpen_APIName returns an xmlIOFTPOpen_APIParam_1 or NULL in case of error
xmlIOHTTPOpen_APIName returns an xmlIOHTTPOpen_APIParam_1 or NULL in case of error
xmlIOHTTPOpenW_APIName returns an xmlIOHTTPOpenW_APIParam_1 or NULL in case of error
...
xmlCopyError_APIName returns 0 in case of success and -1 in case of xmlCopyError_APIParam_2
...
xmlRegExecErrInfo_APIName returns will be freed with the @exec xmlRegExecErrInfo_APIParam_2 and do not need to be deallocated
xmlRegExecNextValues_APIName returns will be freed with the @exec xmlRegExecNextValues_APIParam_1 and do not need to be deallocated
...
xmlStrdup_APIName returns a new xmlStrdup_APIParam_1 or NULL
xmlStrndup_APIName returns a new xmlStrndup_APIParam_1 or NULL
...
xmlSchemaGetValidErrors_APIName returns -1 in case of xmlSchemaGetValidErrors_APIParam_2 and 0 otherwise
xmlRelaxNGGetValidErrors_APIName returns -1 in case of xmlRelaxNGGetValidErrors_APIParam_2 and 0 otherwise
...
xmlXPathNewParserContext_APIName returns the xmlXPathNewParserContext_APIParam_2 just allocated
...
xmlXPathObjectCopy_APIName returns the newly created xmlXPathObjectCopy_APIParam_1
...
xmlXPtrNewRangeNodeObject_APIName returns the newly created xmlXPtrNewRangeNodeObject_APIParam_2
xmlXPtrNewRangeNodePoint_APIName returns the newly created xmlXPtrNewRangeNodePoint_APIParam_2
xmlXPtrNewRangeNodes_APIName returns the newly created xmlXPtrNewRangeNodes_APIParam_0
xmlXPtrNewRangePointNode_APIName returns the newly created xmlXPtrNewRangePointNode_APIParam_1
xmlXPtrNewRangePoints_APIName returns the newly created xmlXPtrNewRangePoints_APIParam_2
...
xmlXPathNodeSetCreate_APIParam_1 is an initial xmlXPathNodeSetCreate_APIParam_1 , or NULL
...
The xmlXPathSetContextNode_APIParam_1 must be in the same document as that associated with the xmlXPathSetContextNode_APIParam_2
...
xmlNewTextWriterTree_APIParam_2 is xmlNewTextWriterTree_APIParam_2 or NULL for xmlNewTextWriterTree_APIParam_1 - > children
...
Start an xmlTextWriterStartAttributeNS_APIParam_4 with namespace support
...
FALSE if not
FALSE if not
Start an xmlTextWriterStartElementNS_APIParam_4 with namespace support
...
Write a formatted xmlTextWriterWriteVFormatElementNS_APIParam_4 with namespace support
...
xmlSaveToBuffer_APIName returns a new xmlSaveToBuffer_APIParam_2 or NULL in case of error
xmlSaveToFd_APIName returns a new xmlSaveToFd_APIParam_2 or NULL in case of error
xmlSaveToFilename_APIName returns a new xmlSaveToFilename_APIParam_2 or NULL in case of error
...
Contrary to xmlEncodeEntitiesReentrant_APIParam_2 , this routine is reentrant , and result must be deallocated
remove xmlEncodeEntities_APIParam_2 , once we are not afraid of breaking binary compatibility People must migrate their code to xmlEncodeEntities_APIParam_2
...
xmlGetDocEntity returns A xmlGetDocEntity_APIParam_2 to the entity structure or NULL if not found
xmlGetDtdEntity returns A xmlGetDtdEntity_APIParam_2 to the entity structure or NULL if not found
xmlGetParameterEntity returns A xmlGetParameterEntity_APIParam_2 to the entity structure or NULL if not found
...
xmlXPtrNewContext_APIParam_2 is the xmlXPtrNewContext_APIParam_3 that directly contains the XPointer being evaluated or NULL
...
xmlPathToURI_APIName returns a new URI, or a duplicate of the xmlPathToURI_APIParam_1 parameter if the xmlPathToURI_APIParam_1 fails
xmlSaveUri_APIName returns a new xmlSaveUri_APIParam_0 (to be deallocated by caller
It will try to escape the xmlURIEscape_APIParam_1 needing this , but this is heuristic based it is impossible to be sure
xmlURIEscapeStr_APIName returns a new escaped xmlURIEscapeStr_APIParam_1 or NULL in case of error
...
xmlRelaxNGNewMemParserCtxt_APIName returns the xmlRelaxNGNewMemParserCtxt_APIParam_1 or NULL in case of error
xmlRelaxNGNewParserCtxt_APIName returns the xmlRelaxNGNewParserCtxt_APIParam_1 or NULL in case of error
...
xmlRelaxNGParse_APIName returns the internal xmlRelaxNGParse_APIParam_1 built from the resource or NULL in case of error
...
xmlSchemaSAXPlug_APIName returns a xmlSchemaSAXPlug_APIParam_2 to a xmlSchemaSAXPlug_APIParam_3 needed to unplug the xmlSchemaSAXPlug_APIParam_3 or NULL in case of errors
...
The value of htmlEncodeEntities_APIParam_2 after return is the number of octets consumed
The value of htmlEncodeEntities_APIParam_2 after return is the number of octets consumed
The value of htmlEncodeEntities_APIParam_2 after return is the number of octets consumed
The value of htmlEncodeEntities_APIParam_2 after return is the number of octets consumed
The value of htmlEncodeEntities_APIParam_2 after return is the number of octets consumed
...
The value of htmlEncodeEntities_APIParam_2 after return is the number of octets consumed
The value of htmlEncodeEntities_APIParam_2 after return is the number of octets consumed
The value of xmlCharEncodingOutputFunc_APIParam_4 after return is the number of octets consumed if the return value is positive, else unpredictiable
The value of xmlCharEncodingOutputFunc_APIParam_4 after return is the number of octets consumed if the return value is positive, else unpredictiable
The value of xmlCharEncodingOutputFunc_APIParam_4 after return is the number of octets consumed if the return value is positive, else unpredictiable
The value of xmlCharEncodingOutputFunc_APIParam_4 after return is the number of octets consumed if the return value is positive, else unpredictiable
The value of htmlEncodeEntities_APIParam_2 after return is the number of octets consumed
...
limit itself to 45 xmlCharEncFirstLine_APIParam_1
...
The value of xmlCharEncodingOutputFunc_APIParam_2 after return is the number of octets produced
...
xmlCopyError_APIParam_1 is a xmlCopyError_APIParam_2
...
xmlNanoFTPConnectTo_APIName returns an xmlNanoFTPConnectTo_APIParam_1 or NULL if xmlNanoFTPConnectTo_APIName failed
...
Initialize the xmlNanoFTPScanProxy_APIParam_1 by parsing the xmlNanoFTPScanProxy_APIParam_1 and finding the protocol host port it indicates
Initialize the xmlNanoHTTPScanProxy_APIParam_1 by parsing the xmlNanoHTTPScanProxy_APIParam_1 and finding the protocol host port it indicates
...
xmlC14NExecute_APIParam_5 is the xmlC14NExecute_APIParam_2 of inclusive namespace prefixes ended with a NULL or NULL
...
xmlTextReaderConstBaseUri_APIName returns the base URI or NULL if not available, the xmlTextReaderConstBaseUri_APIParam_0 will be deallocated with the xmlTextReaderConstBaseUri_APIParam_1
xmlTextReaderConstLocalName_APIName returns the local name or NULL if not available, the xmlTextReaderConstLocalName_APIParam_0 will be deallocated with the xmlTextReaderConstLocalName_APIParam_1
xmlTextReaderConstName_APIName returns the local name or NULL if not available, the xmlTextReaderConstName_APIParam_0 is deallocated with the xmlTextReaderConstName_APIParam_1
xmlTextReaderConstPrefix_APIName returns the prefix or NULL if not available, the xmlTextReaderConstPrefix_APIParam_0 is deallocated with the xmlTextReaderConstPrefix_APIParam_1
xmlTextReaderPrefix_APIName returns the prefix or NULL if not available, if non NULL it need to be freed by the caller
xmlTextReaderConstNamespaceUri_APIName returns the namespace URI or NULL if not available, the xmlTextReaderConstNamespaceUri_APIParam_0 will be deallocated with the xmlTextReaderConstNamespaceUri_APIParam_1
...
xmlTextReaderConstString_APIName returns an interned copy of the xmlTextReaderConstString_APIParam_2 or NULL in case of error
xmlStrdupFunc_APIName returns the copy of the xmlStrdupFunc_APIParam_1 or NULL in case of error
...
xmlSchemaCollapseString_APIName returns the new string or NULL if no xmlSchemaCollapseString_APIParam_1 was required
xmlSchemaWhiteSpaceReplace_APIName returns the new string or NULL if no xmlSchemaWhiteSpaceReplace_APIParam_1 was required
...
xmlTextReaderConstXmlVersion_APIName returns a xmlTextReaderConstXmlVersion_APIParam_0 containing the xmlTextReaderConstXmlVersion_APIParam_1 of the document or NULL in case of error
as a result of this call , the xmlTextReaderCurrentDoc_APIParam_1 will not destroy the associated xmlTextReaderCurrentDoc_APIParam_1 and calling xmlFreeDoc_APIName on the result is needed once the xmlTextReaderCurrentDoc_APIParam_1 parsing has finished
...
xmlTextReaderExpand_APIName returns a xmlTextReaderExpand_APIParam_1 valid until the next xmlTextReaderRead_APIName call or NULL in case of error
...
Since attribute value and end of line normalizations are a MUST in the xmlTextReaderNormalization_APIParam_1 only the value true is accepted
...
xmlTextReaderRelaxNGSetSchema_APIName returns 0 in case the xmlTextReaderRelaxNGSetSchema_APIParam_2 could be activated and -1 in case of error
xmlTextReaderRelaxNGValidate_APIName returns 0 in case the schemas validation could be activated and -1 in case of error
xmlTextReaderRelaxNGValidateCtxt_APIName returns 0 in case the xmlTextReaderRelaxNGValidateCtxt_APIParam_2 could be activated and -1 in case of error
xmlTextReaderSchemaValidate_APIName returns 0 in case the schemas validation could be activated and -1 in case of error
xmlTextReaderSchemaValidateCtxt_APIName returns 0 in case the xmlTextReaderSchemaValidateCtxt_APIParam_2 could be activated and -1 in case of error
...
@ The xmlTextReaderSetSchema_APIParam_2 should not be call xmlRegFreeRegexp_APIName is deallocated or its use has been deactivated
...
xmlNanoHTTPSave_APIParam_2 is the xmlNanoHTTPSave_APIParam_2 where the xmlNanoHTTPSave_APIParam_2 should be saved
...
xmlXPathCompareValues_APIName returns 1 if the xmlXPathCompareValues_APIParam_1 succeeded, 0 if it failed
The < xmlXPathCompareValues_APIParam_1 will be true if the first number is less than the second number
The < = xmlXPathCompareValues_APIParam_1 will be true if the first number is greater than the second number
The < = xmlXPathCompareValues_APIParam_1 will be true if the first number is less than or equal to the second number
The < = xmlXPathCompareValues_APIParam_1 will be true if the first number is greater than or equal to the second number
Implement the boolean_APIName XPath function boolean boolean The boolean function converts its xmlXPathBooleanFunction_APIParam_2 to a boolean as follows
Implement the contains_APIName XPath function boolean contains The contains function returns true if the first xmlXPathContainsFunction_APIParam_2 contains the second argument string, and otherwise returns false
- a number is true
...
xmlXPathHasSameNodes_APIName returns true  if xmlXPathHasSameNodes_APIParam_1 any xmlXPathHasSameNodes_APIParam_2 with @nodes2, false  otherwise
...
xmlXPathNodeSetMerge_APIParam_1 is the first xmlXPathNodeSetMerge_APIParam_2 or NULL
Namespace nodes in xmlXPathNodeSetFreeNs_APIParam_1 do not match the XPath semantic
...
Implement the not_APIName xmlXPathNotFunction_APIParam_1 not The not function returns true if its xmlXPathNotFunction_APIParam_2 is false, and false otherwise
xmlXPathRegisterFunc_APIParam_3 is the xmlXPathRegisterFunc_APIParam_3 or NULL
xmlXPathRegisterFuncNS_APIParam_4 is the xmlXPathRegisterFuncNS_APIParam_4 or NULL
...
Implement the starts-with_APIName XPath function boolean starts-with The starts-with function returns true if the first xmlXPathStartsWithFunction_APIParam_2 starts with the second argument string, and otherwise returns false
...
the xmlXPathSubstringFunction_APIParam_1 and addition used for the above follow the standard IEEE 754 rules
occurrences of that character in the first xmlXPathTranslateFunction_APIParam_2 are removed
...
xmlPatternGetStreamCtxt_APIName returns a xmlPatternGetStreamCtxt_APIParam_1 to the context or NULL in case of failure
...
Both @name and xmlStreamPushNode_APIParam_3 being NULL means the / i.e
Both @name and xmlStreamPushNode_APIParam_3 being NULL means the / i.e
Both @name and xmlStreamPushNode_APIParam_3 being NULL means the / i.e
Both @name and xmlStreamPushNode_APIParam_3 being NULL means the / i.e
Both @name and xmlStreamPushNode_APIParam_3 being NULL means the / i.e
...
xmlStreamPush_APIParam_1 for xmlStreamPush_APIParam_2 and xmlStreamPush_APIParam_3 will be expected to come from the dictionary
xmlStreamPushAttr_APIParam_1 for xmlStreamPushAttr_APIParam_2 and xmlStreamPushAttr_APIParam_3 will be expected to come from the dictionary
xmlStreamPushNode_APIParam_1 for xmlStreamPushNode_APIParam_2 and xmlStreamPushNode_APIParam_3 will be expected to come from the dictionary
...
xmlMemStrdupLoc_APIName returns a pointer to the new xmlMemStrdupLoc_APIParam_1 or NULL if xmlMemStrdupLoc_APIParam_3 occurred
xmlMemoryStrdup_APIName returns a pointer to the new xmlMemoryStrdup_APIParam_1 or NULL if allocation error occurred
...
xmlShellPrintXPathError_APIParam_1 is valid xmlShellPrintXPathError_APIParam_1
...
xmlStrcasestr_APIName returns the xmlChar xmlStrcasestr_APIParam_2 for the first occurrence or NULL
xmlStrchr_APIName returns the xmlChar xmlStrchr_APIParam_2 for the first occurrence or NULL
xmlStrstr_APIName returns the xmlChar xmlStrstr_APIParam_2 for the first occurrence or NULL
xmlStrsub_APIName returns the xmlChar xmlStrsub_APIParam_1 for the first occurrence or NULL
...
xmlUTF8Strloc_APIName returns the relative xmlUTF8Strloc_APIParam_2 of the desired xmlUTF8Strloc_APIParam_2 or -1 if not found
...
xmlUTF8Strsub_APIName returns a xmlUTF8Strsub_APIParam_1 to a newly created string or NULL if any problem
...
The remaining xmlCreatePushParserCtxt_APIParam_5 will be parsed so The remaining xmlCreatePushParserCtxt_APIParam_5 do not need to be fed in again through xmlCreatePushParserCtxt_APIParam_3
...
xmlBufContent_APIName returns the internal xmlBufContent_APIParam_1
xmlBufferContent_APIName returns the internal xmlBufferContent_APIParam_1
...
xmlBufferShrink_APIName returns the number of xmlBufferShrink_APIParam_1 removed, or -1 in case of failure
...
Ensures that the tree is namespace wellformed by creating additional xmlDOMWrapAdoptNode_APIParam_6 where needed
...
This will substitute xmlDOMWrapRemoveNode_APIParam_4 to xmlDOMWrapRemoveNode_APIParam_3 - > nsDef for xmlDOMWrapRemoveNode_APIParam_4 to doc - > oldNs , thus ensuring the removed branch to be autark xmlDOMWrapRemoveNode_APIParam_4
...
XML special xmlNewChild_APIParam_4 must be escaped first by using xmlEncodeEntitiesReentrant_APIName , or xmlNewTextChild_APIName should be used
...
xmlNodeListGetRawString_APIParam_3 is should we replace xmlNodeListGetRawString_APIParam_2 or show their external form
xmlNodeListGetString_APIParam_3 is should we replace xmlNodeListGetString_APIParam_2 or show their external form
...
xmlReplaceNode_APIName returns the @old xmlReplaceNode_APIParam_2
...
Note that namespace nodes can not be unlinked as they do not have xmlUnlinkNode_APIParam_1 to their parent
...
xmlListCreate_APIName returns the new xmlListCreate_APIParam_2 or NULL in case of error
xmlListDataCompare_APIName returns 0 is equality, -1 or 1 otherwise depending on the ordering
xmlListDup_APIName returns a new copy of the xmlListDup_APIParam_1 or NULL in case of error
...
xmlOutputBufferCreateIO_APIName returns the new xmlOutputBufferCreateIO_APIParam_2 or NULL
...
xmlCheckHTTPInput_APIName returns the xmlCheckHTTPInput_APIParam_2 or NULL in case of HTTP error
...
xmlInputOpenCallback_APIName returns an xmlInputOpenCallback_APIParam_1 or NULL in case or error
...
xmlOutputBufferGetContent_APIName returns a xmlOutputBufferGetContent_APIParam_1 to the data or NULL in case of error
...
xmlOutputOpenCallback_APIName returns an xmlOutputOpenCallback_APIParam_1 or NULL in case or error
...
to what xmlCatalogSetDefaults_APIParam_1 should be accepted
to what xmlCatalogSetDefaults_APIParam_1 should be accepted
to what xmlCatalogSetDefaults_APIParam_1 should be accepted
to what xmlCatalogSetDefaults_APIParam_1 should be accepted
...
xmlCatalogSetDefaults_APIParam_1 is what xmlCatalogSetDefaults_APIParam_1 should be accepted
...
xmlSchemaNewNOTATIONValue_APIName returns a xmlSchemaNewNOTATIONValue_APIParam_2 to the new value or NULL in case of error
xmlSchemaNewQNameValue_APIName returns a xmlSchemaNewQNameValue_APIParam_2 to the new value or NULL in case of an error
...
xmlSchemaNewStringValue_APIName returns a xmlSchemaNewStringValue_APIParam_2 to the new xmlSchemaNewStringValue_APIParam_2 or NULL in case of error
...
Note that @value needs to be the xmlSchemaValidateFacetWhtsp_APIParam_6 normalized xmlSchemaValidateFacetWhtsp_APIParam_6 xmlSchemaValidateFacetWhtsp_APIParam_4

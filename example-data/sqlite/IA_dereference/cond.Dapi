...
null
null
If any sqlite3_bind__APIName routine is call sqlite3_finalize_APIName that has been finalized
null
...
if SQLite is call sqlite3_threadsafe_APIName
if SQLite is call sqlite3_threadsafe_APIName
if SQLite is compiled with the SQLITE_ENABLE_DESERIALIZE option
null
null
...
If two or more threads call one or more column metadata interfaces for the same prepared statement and call sqlite3_column_origin_name_APIName at the same time
...
null
null
if the database connection sqlite3_snapshot_open_APIParam_1 does call sqlite3_snapshot_recover_APIName for schema sqlite3_snapshot_open_APIParam_2 is in WAL mode
...
null
null
If the two snapshot handles are call sqlite3_snapshot_recover_APIName
null
null
null

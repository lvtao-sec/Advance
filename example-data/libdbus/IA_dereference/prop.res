...
dbus_set_error_from_message_APIName return TRUE if the dbus_set_error_from_message_APIParam_2 had dbus_set_error_from_message_APIParam_2
...
that is , you recurse into the array , and you call dbus_message_iter_get_fixed_array_APIName on the  dbus_message_iter_recurse_APIParam_2  created by dbus_message_iter_recurse_APIName
...
dbus_realloc_APIName return allocated dbus_realloc_APIParam_1, or NULL if the dbus_realloc_APIParam_2 fails
...
You can not continue to use any dbus_shutdown_APIParam_1 , such as connections , that were allocated prior to dbus_shutdown_APIName
The purpose of dbus_shutdown_APIName is to allow applications to call dbus_timeout_get_interval_APIName with dbus_timeout_get_interval_APIParam_1 from memory leak checkers
...
dbus_get_local_machine_id_APIName returns NULL if there was not enough memory to read the UUID, or if the UUID could not be read because the dbus_get_local_machine_id_APIParam_1 was installed incorrectly
dbus_message_demarshal_APIName return NULL if there was an dbus_message_demarshal_APIParam_3
this will result in processing of the special Disconnected signal , which may result in a call to _exit_APIName , 
One implication of this is that calling dbus_shutdown_APIName from a library is almost certainly wrong
Alternatively , there are dbus_get_version_APIParam_1 , #DBUS_MINOR_VERSION , #DBUS_MICRO_VERSION , and #DBUS_VERSION which allow you to test the VERSION YOU ARE COMPILED AGAINST
dbus_setenv_APIParam_2 is dbus_setenv_APIParam_2 of dbus_setenv_APIParam_1 , or NULL to unset
...
The machine ID can also be used to call dbus_bus_get_unique_name_APIName with instances
...
The call dbus_server_allocate_data_slot_APIName with ID may be used with dbus_pending_call_set_data_APIName and dbus_pending_call_get_data_APIName
The call dbus_server_allocate_data_slot_APIName with ID may be used with dbus_message_set_data_APIName and dbus_message_get_data_APIName
The call dbus_server_allocate_data_slot_APIName with ID may be used with dbus_server_set_data_APIName and dbus_server_get_data_APIName
The call dbus_server_allocate_data_slot_APIName with ID may be used with dbus_connection_set_data_APIName and dbus_connection_get_data_APIName
...
The dbus_connection_allocate_data_slot_APIParam_1 must be initialized to -1 , and is filled in with the dbus_connection_allocate_data_slot_APIParam_1
The dbus_connection_allocate_data_slot_APIParam_1 must be initialized to -1 , and is filled in with the dbus_connection_allocate_data_slot_APIParam_1
The dbus_connection_allocate_data_slot_APIParam_1 must be initialized to -1 , and is filled in with the dbus_connection_allocate_data_slot_APIParam_1
The dbus_connection_allocate_data_slot_APIParam_1 must be initialized to -1 , and is filled in with the dbus_connection_allocate_data_slot_APIParam_1
The dbus_connection_allocate_data_slot_APIParam_1 must be initialized to -1 , and is filled in with the dbus_connection_allocate_data_slot_APIParam_1
...
dbus_message_set_member_APIName return FALSE if not enough dbus_message_set_member_APIParam_2
...
dbus_message_new_APIName return new dbus_message_new_APIParam_1 or NULL if no memory
...
The last dbus_message_append_args_APIParam_2 to dbus_message_append_args_APIName must be DBUS_TYPE_INVALID , marking the end of the dbus_message_append_args_APIParam_2
...
dbus_message_append_args_APIParam_2 and DBUS_TYPE_VARIANT and complex arrays Todo
...
The supported dbus_message_get_args_APIParam_3 include those supported by dbus_message_append_args_APIName
Similar to dbus_message_get_fixed_array_APIName dbus_message_get_args_APIName does not support arrays of dbus_message_get_args_APIParam_3
dbus_message_get_args_APIParam_3 and DBUS_TYPE_VARIANT and complex arrays dbus_message_get_args_APIParam_1 is the dbus_message_get_args_APIParam_1
...
In addition to those dbus_message_get_args_APIParam_3 , arrays of string , object path , and signature are supported
...
The dbus_message_is_method_call_APIParam_1 allows dbus_message_is_method_call_APIParam_3 callers to leave out the interface name
it will be assumed equal to the provided dbus_message_is_method_call_APIParam_2
This should only be used to abandon creation of a dbus_message_iter_abandon_container_APIParam_2
The  value  argument should be the address of a basic-typed dbus_message_iter_append_basic_APIParam_3
return result
dbus_bool_t result = FALSE
result = TRUE
You may call dbus_message_iter_append_fixed_array_APIName multiple dbus_message_iter_append_fixed_array_APIParam_1 for the same array
...
You can call dbus_connection_read_write_APIName with loop as follows
...
So for int32 it should be a  dbus_int32_t dbus_message_iter_get_basic_APIParam_1  and for string a  const char
To read any container type you will need to call dbus_message_iter_recurse_APIName with recurse container with dbus_message_iter_recurse_APIName
...
dbus_message_iter_get_fixed_array_APIName should only be used if dbus_type_is_fixed_APIName returns TRUE for the dbus_message_iter_get_fixed_array_APIParam_3
dbus_connection_flush_APIName should only be used
So for int32 it should be a  dbus_message_iter_get_fixed_array_APIParam_1 **  dbus_message_iter_get_fixed_array_APIParam_0 dbus_message_iter_get_fixed_array_APIParam_2 is by reference and should not be freed
dbus_message_iter_get_signature_APIName return the contained signature, or NULL if out of memory
Some types of argument can only be read with dbus_message_iter_init_APIParam_2 however
...
dbus_message_marshal_APIParam_3 is the location to save the dbus_message_marshal_APIParam_3 of the marshalled form to
...
dbus_message_new_error_printf_APIName return a new dbus_message_new_error_printf_APIParam_3
...
dbus_message_ref_APIName return the dbus_message_ref_APIParam_1 See also dbus_message_ref_APIParam_1
...
The dbus_message_set_container_instance_APIParam_2 must contain only valid dbus_message_set_container_instance_APIParam_2 for an object dbus_message_set_container_instance_APIParam_2 as defined in the dbus_message_set_container_instance_APIParam_1
dbus_message_set_destination_APIParam_2 is the dbus_message_set_destination_APIParam_2 name or NULL to unset
The dbus_message_set_destination_APIParam_2 name must contain only valid dbus_message_set_destination_APIParam_2 as defined in the dbus_message_set_destination_APIParam_1
The dbus_message_set_member_APIParam_2 name must contain only valid dbus_message_set_member_APIParam_2 as defined in the dbus_message_set_member_APIParam_1
The error name must contain only valid dbus_message_set_error_name_APIParam_2 as defined in the dbus_message_set_error_name_APIParam_1
...
The interface name must contain only valid dbus_message_set_interface_APIParam_2 as defined in the dbus_message_set_interface_APIParam_1
...
The dbus_message_set_path_APIParam_2 must contain only valid dbus_message_set_path_APIParam_2 as defined in the dbus_message_set_path_APIParam_1
The dbus_message_set_sender_APIParam_2 must be a valid bus name as defined in the dbus_message_set_sender_APIParam_1
...
NULL can always be passed instead of a dbus_validate_utf8_APIParam_2
NULL can always be passed instead of a dbus_validate_utf8_APIParam_2
NULL can always be passed instead of a dbus_validate_utf8_APIParam_2
NULL can always be passed instead of a dbus_validate_utf8_APIParam_2
NULL can always be passed instead of a dbus_validate_utf8_APIParam_2
...
NULL can always be passed instead of a dbus_validate_utf8_APIParam_2
NULL can always be passed instead of a dbus_validate_utf8_APIParam_2
The results are undefined if the current type is a dbus_signature_iter_recurse_APIParam_1 -LRB- dbus_signature_iter_recurse_APIParam_1
...
It is an error to pass an invalid dbus_type_is_fixed_APIParam_1 , other than DBUS_TYPE_INVALID , to this function
It is an error to pass an invalid dbus_type_is_fixed_APIParam_1 , other than DBUS_TYPE_INVALID , to this function
DBUS_TYPE_INVALID is not a dbus_type_is_container_APIParam_1
...
This is an ID unique to each dbus_server_get_id_APIParam_1
...
Remember that a dbus_server_get_id_APIParam_1 represents only one mode of connecting , so e.g
dbus_server_get_id_APIName return the id of the dbus_server_get_id_APIParam_1 or NULL if no memory
a dbus_server_get_id_APIParam_1 can listen on multiple addresses which will mean it has multiple dbus_server_get_id_APIParam_1 each with their own ID
...
dbus_server_set_auth_mechanisms_APIName only affects dbus_server_set_auth_mechanisms_APIParam_2 created after it is called
Pass NULL instead of an array to use all available dbus_server_set_auth_mechanisms_APIParam_2
These dbus_connection_set_timeout_functions_APIParam_6 are responsible for making the application main loop aware of dbus_connection_set_timeout_functions_APIParam_4
These dbus_connection_set_timeout_functions_APIParam_6 are responsible for making the application main loop aware of dbus_connection_set_timeout_functions_APIParam_4
These dbus_connection_set_timeout_functions_APIParam_6 are responsible for making the application main loop aware of dbus_connection_set_timeout_functions_APIParam_4
These dbus_connection_set_timeout_functions_APIParam_6 are responsible for making the application main loop aware of dbus_connection_set_timeout_functions_APIParam_4
These dbus_connection_set_watch_functions_APIParam_6 are responsible for making the application main loop aware of file descriptors that need to be monitored for events
...
Strings on dbus_validate_utf8_APIParam_2 must be valid UTF-8
...
This is probably a feature , as filters could create arbitrary dbus_connection_add_filter_APIParam_4
...
You must close a dbus_connection_close_APIParam_1 prior to call dbus_server_unref_APIName with reference to the dbus_connection_close_APIParam_1
...
If the dbus_connection_get_server_id_APIParam_1 is on the dbus_server_get_id_APIParam_1 side, this will always return NULL - use dbus_server_get_id_APIName to get the ID of your own server, if you are the dbus_server_get_id_APIParam_1 side
...
Always returns FALSE on dbus_connection_get_windows_user_APIParam_2 for now
...
You can ask the dbus_connection_get_unix_user_APIParam_1 to tell you the UID of another dbus_connection_get_unix_user_APIParam_1 like
...
We would like to be able to say  You can ask the dbus_connection_get_windows_user_APIParam_1 to tell you the user of another dbus_connection_get_windows_user_APIParam_1 like
dbus_connection_list_registered_APIParam_3 is returns NULL -terminated array of dbus_connection_list_registered_APIParam_3
...
Otherwise, returns a new dbus_connection_open_APIParam_0 and saves the new dbus_connection_open_APIParam_0 for possible dbus_connection_open_APIParam_1 if a future call to dbus_connection_open_APIName asks to connect to the same server
...
Note Prefer dbus_connection_open_APIName to dbus_connection_open_private_APIName 
Note Prefer dbus_connection_open_APIName to dbus_connection_open_private_APIName 
Note Prefer dbus_connection_open_APIName to dbus_connection_open_private_APIName 
Note Prefer dbus_connection_open_APIName to dbus_connection_open_private_APIName 
...
Instead , call dbus_connection_read_write_APIName with loop invoke dbus_connection_dispatch_APIName
you must dbus_connection_close_APIName to disconnect it , and dbus_connection_unref_APIName to free the dbus_connection_open_private_APIParam_1
...
dbus_connection_remove_filter_APIParam_2 is the dbus_connection_remove_filter_APIParam_2 to remove
It is a programming error to call dbus_connection_remove_filter_APIName for a dbus_connection_remove_filter_APIParam_2 that has not been added as a filter
...
a dbus_connection_send_with_reply_APIParam_4 will occur , unlike with dbus_connection_send_APIName
...
dbus_connection_dispatch_APIName needs to be called to call dbus_connection_pop_message_APIName with process messages
The call to _exit_APIName comes after any handlers for the disconnect signal run
messages should be dispatched later
Instead , the dbus_connection_set_dispatch_status_function_APIParam_2 should simply save an indication that
...
However , the dbus_connection_set_route_peer_messages_APIParam_2 wants to be able to route methods on that interface through the dbus_connection_set_route_peer_messages_APIParam_2 and to other applications
it can break things badly
A disabled dbus_connection_set_timeout_functions_APIParam_4 should have no effect , and enabled dbus_connection_set_timeout_functions_APIParam_4 should be added to the main loop
This feature is used instead of simply adding/removing the dbus_connection_set_timeout_functions_APIParam_4
dbus_timeout_handle_APIName should be called repeatedly , each dbus_connection_set_timeout_functions_APIParam_4 the interval elapses , starting after it has elapsed once
so inside these dbus_connection_set_watch_functions_APIParam_6 you may not invoke any methods on dbus_connection_set_watch_functions_APIParam_1 or it will deadlock
so inside these dbus_connection_set_watch_functions_APIParam_6 you may not invoke any methods on dbus_connection_set_watch_functions_APIParam_1 or it will deadlock
so inside these dbus_connection_set_watch_functions_APIParam_6 you may not invoke any methods on dbus_connection_set_watch_functions_APIParam_1 or it will deadlock
so inside these dbus_connection_set_watch_functions_APIParam_6 you may not invoke any methods on dbus_connection_set_watch_functions_APIParam_1 or it will deadlock
...
This feature is used instead of simply adding/removing the dbus_connection_set_watch_functions_APIParam_4
it may not be enabled
A disabled dbus_connection_set_watch_functions_APIParam_4 should have no effect , and enabled dbus_connection_set_watch_functions_APIParam_4 should be added to the main loop
These dbus_connection_set_watch_functions_APIParam_6 are responsible for making the application main loop aware of file descriptors that need to be monitored for events , using select_APIName or poll_APIName
...
dbus_watch_handle_APIName can not be called , as the dbus_connection_set_watch_functions_APIParam_1 will not be ready to handle that dbus_connection_set_watch_functions_APIParam_4 yet
Once a file descriptor becomes readable or writable , or an exception occurs , dbus_watch_handle_APIName should be called to notify the dbus_connection_set_watch_functions_APIParam_1 of the dbus_connection_set_watch_functions_APIParam_1
...
As a result , it is not sufficient to call dbus_threads_init_default_APIName in a library or plugin , 
...
If dbus_bus_get_APIName obtains a new dbus_connection_set_exit_on_disconnect_APIParam_1 never before returned from dbus_bus_get_APIName , it will call dbus_connection_set_exit_on_disconnect_APIName , so the dbus_connection_set_exit_on_disconnect_APIParam_2 will exit if the dbus_bus_get_APIParam_0 closes
Asks the dbus_bus_get_id_APIParam_2 to return its globally unique ID, as described in the dbus_bus_get_id_APIParam_2
dbus_bus_get_id_APIName return the dbus_bus_get_id_APIParam_2 or NULL if dbus_bus_get_id_APIParam_2 is set
For the dbus_bus_get_id_APIParam_2 , probably the dbus_bus_get_id_APIParam_2 is not useful
instead , use the machine ID and may be persistent beyond a single dbus_bus_get_id_APIParam_2
...
In addition to an ID for each dbus_bus_get_id_APIParam_2 and an ID for each machine , there is an ID for each address that the dbus_bus_get_id_APIParam_2 is listening on
Asks the dbus_bus_get_unix_user_APIParam_3 to return the UID the named dbus_bus_get_unix_user_APIParam_1 authenticated as, if any
...
it should not be call dbus_connection_read_write_APIName with loop
it should not be call dbus_connection_read_write_APIName with loop
it should not be call dbus_connection_read_write_APIName with loop
it should not be call dbus_connection_read_write_APIName with loop
If dbus_timeout_handle_APIName returns FALSE , there wasn't enough memory to handle the dbus_timeout_handle_APIParam_1
with Qt you might store the dbus_timeout_set_data_APIParam_1 for this dbus_timeout_set_data_APIParam_1 and with GLib you might store a g_timeout_add dbus_timeout_set_data_APIParam_2
...
Gets flags from dbus_watch_get_flags_APIParam_1 indicating what conditions should be monitored on the file descriptor
